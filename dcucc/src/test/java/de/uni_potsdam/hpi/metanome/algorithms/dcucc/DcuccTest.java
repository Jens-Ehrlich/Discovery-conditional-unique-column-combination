...
public class DcuccTest {
  ...
  @Test
    ...
    @Test
    public void testCalculateInputAndConfiguration() throws AlgorithmConfigurationException, CouldNotReceiveResultException, UnsupportedEncodingException, FileNotFoundException, InputGenerationException, InputIterationException {
        //Setup
        ...
        algorithm.setRelationalInputConfigurationValue(Dcucc.INPUT_FILE_TAG, expectedRelationalInputGenerator);

        ConditionalUniqueColumnCombinationResultReceiver expectedResultReceiver = mock(ConditionalUniqueColumnCombinationResultReceiver.class);
